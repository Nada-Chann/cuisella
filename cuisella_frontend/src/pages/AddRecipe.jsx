...
const AddRecipe = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!token) throw new Error("You need to be logged in to add a recipe");
      ...
      <form onSubmit={handleSubmit}>
          ...
          <div>
            <div className="relative mb-4">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border rounded focus:ring-2 focus:ring-[#CA7842] bg-white"
                required
              />
            </div>
            <div className="relative mb-4">
              ...
              <textarea
                ...
                className="w-full pl-10 pr-4 py-2 border rounded focus:ring-2 focus:ring-[#CA7842] h-28 resize-none bg-white"
                required
                spellCheck={false}
              />
            </div>
            <div className="mb-4">
              <label className="block text-sm font-medium text-[#4B352A] mb-2">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center px-4 py-2 border border-[#CA7842] text-[#4B352A] rounded-md bg-white hover:bg-[#F2D6B3] transition text-sm font-medium"
                >
                ...
                />
                {form.image && (
                  <span className="text-sm text-[#4B352A]">
                    {form.image.name}
                  </span>
                )}
              </div>
          ...
          <div>
            ...
            <div className="relative mb-4">
              ...
              <input
                ...
                value={form.tag}
                onChange={handleChange}
                placeholder="Tag (e.g., dessert, vegan)"
                className="w-full pl-10 pr-4 py-2 border rounded focus:ring-2 focus:ring-[#CA7842] bg-white"
              />
            </div>
          </div>
        ...
        <div className="mt-6">
          <button
            ...
            className={`w-full py-3 bg-[#CA7842] text-white font-bold rounded-lg hover:bg-[#A55D2B] transition ${
